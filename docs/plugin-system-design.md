...
Status: **P1–P4 shipped** (P3 panels + P4 slash/Tavern-Helper shim done; see the
phase table in §11). This
...
| **D3/P3** 🟡 | **App-extension contributions**: ✅ `rpt.ui.registerPanel` — standalone plugins get a visible, titled, auto-sizing panel in the right sidebar (iframes on a stable mount so they never reparent/reload); lifecycle event hooks already wired. ⬜ `registerButton` (shell toolbar) + `registerCommand` still to come.                                                                                                                                                                                                                                                                                         | tabbed shell, P2 runtime    |

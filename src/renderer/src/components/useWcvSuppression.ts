 ...
 * open. Native WebContentsViews always paint ABOVE the renderer DOM, so a Modal or the
 * workflow-editor overlay can't cover them — the host must hide them instead.
 *

...
const zh: Record<string, string> = {
  ...
  // 维护标签页（WP2）：立即维护工作台 + 提示词预览 + 进度/回填。
  'memoryManager.maintenance.runTitle': '立即维护',
  'memoryManager.maintenance.runIntro': '对最近若干层运行一次维护，根据对话内容填写表格记忆。',
  'memoryManager.maintenance.lastNFloors': '最近楼层数',
  'memoryManager.maintenance.extraHint': '额外指令（可选）',
  'memoryManager.maintenance.extraHintPlaceholder': '例如：重点维护纪要表，忽略战斗细节……',
  'memoryManager.maintenance.run': '立即运行',
  'memoryManager.maintenance.running': '运行中……',
  'memoryManager.maintenance.resultApplied': '已执行 {{applied}} 条语句，{{changes}} 处改动。',
  'memoryManager.maintenance.resultEmpty': '无需改动。',
  'memoryManager.maintenance.noTemplate': '请先在左侧挂载表格模板。',
  'memoryManager.maintenance.errorNoNode': '本会话没有可运行的记忆维护智能体。',
  'memoryManager.maintenance.errorAborted': '维护调用已中止。',
